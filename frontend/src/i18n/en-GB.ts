export const enGB = {
  ...
  'settings.logoHint': 'PNG, JPG or SVG · max 3 MB',
  'settings.logoRecommended': 'Recommended: square, transparent background (PNG or SVG). Max size: 3 MB.',
  ...
  'settings.proxyUploadSection': 'Proxy & CDN Optimization',
  ...
  // ── OIDC / SSO ──────────────────────────────────────────────────────────────
  'login.or': 'or',
  'login.oidcLoginWith': 'Sign in with {{provider}}',
  'login.oidcLoginGeneric': 'SSO Login',
  'error.oidcOnlyAccount': 'This account uses SSO login. Please use the button below.',
  'error.oidcManagedAccount': 'This account is managed by SSO. Reset your password on your provider.',
  'error.oidcFailed': 'SSO login error',
  'oidc.failed': 'SSO login failed',
  'oidc.errorDisabled': 'OIDC is not configured',
  'oidc.errorInvalidState': 'Session expired, please try again',
  'oidc.errorAccountDisabled': 'Account disabled',
  'oidc.errorEmailRequired': 'Email address is required in the OIDC token',
  'oidc.errorRegistrationDisabled': 'Auto-registration is disabled',
  'oidc.errorServerError': 'OIDC server error',
  'oidc.linkTitle': 'Link your account',
  'oidc.linkDescription': 'A local account already exists with the address <strong>{{email}}</strong>.<br/>Enter your password to confirm the link.',
  'oidc.linkCurrentPassword': 'Current password',
  'oidc.linkConfirm': 'Confirm link',
  'oidc.linkSuccess': 'Account linked successfully!',
  'oidc.linkFailed': 'Failed to link account',
  'oidc.linkPasswordIncorrect': 'Incorrect password',
