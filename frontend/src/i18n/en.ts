export const en = {
  ...
  'settings.chunkSection': 'Chunked upload (resumable)',
  'settings.chunkHint': 'Splits large files into chunks for reliable transfers and allows resuming after a connection drop.',
  'settings.chunkDisabled': 'Disabled',
  'settings.chunkSaved': 'Chunk size saved',
  'settings.chunkRemoved': 'Chunked upload disabled',
  'request.chunkResuming': 'Resuming previous upload…',
