export const fr = {
  ...
  'settings.chunkSection': 'Upload par morceaux (resumable)',
  'settings.chunkHint': 'Découpe les gros fichiers en morceaux pour fiabiliser les envois et permettre la reprise après coupure.',
  'settings.chunkDisabled': 'Désactivé',
  'settings.chunkSaved': 'Taille de morceau enregistrée',
  'settings.chunkRemoved': 'Upload par morceaux désactivé',
  'request.chunkResuming': 'Reprise de l’upload précédent…',
